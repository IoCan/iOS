...
- ( NSMutableDictionary *)sendPay_demo:(NSString *)tn dic:(NSMutableDictionary *)dic title:(NSString *)vaules {
    //订单标题，展示给用户
    NSString *order_name    = vaules;
    //订单金额,单位（分）
    NSString *order_price   = [NSString stringWithFormat:@"%ld",(long)[[dic objectForKey:@"price"] integerValue]*100];//1分钱测试
...
//    NSString *orderno   = [NSString stringWithFormat:@"%ld",time(0)];
    ...
    [packageParams setObject: tn           forKey:@"out_trade_no"];//商户订单号
